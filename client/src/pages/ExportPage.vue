<template>
  <div class="max-w-xl mx-auto bg-white rounded-xl shadow-lg p-8 mt-12 mb-8 text-center relative">
    <router-link
      to="/"
    ...
    <p class="mb-6 text-gray-600">Unduh seluruh data laporan dan perbaikan mesin dalam format Excel (.xlsx).</p>
